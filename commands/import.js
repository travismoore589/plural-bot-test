...
module.exports = {
	...
	usage: cfg =>  ["import [link] - Attach a compatible .json file or supply a link to a file when using this command. Data files can be obtained from compatible bots like Pluralkit, Proxymaster, Tupperbox, etc."],
	permitted: () => true,
